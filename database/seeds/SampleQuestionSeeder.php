...
']);
DB::table('questions_answers')->insert(['abcd' => 'A','content' => 'A. Bầu cử tổng thống', 'correct' => false, 'question_id' => $id]);
...
DB::table('questions_answers')->insert(['abcd' => 'B','content' => 'B. Lâu dài, động viên', 'correct' => false, 'question_id' => $id]);
...
DB::table('questions_answers')->insert(['abcd' => 'D','content' => 'D. Cả 3 đáp án trên', 'correct' => false, 'question_id' => $id]);
...
DB::table('questions_answers')->insert(['abcd' => 'B','content' => 'B. Nơi thu hút, giam chân lực lượng chiến lược của địch', 'correct' => false, 'question_id' => $id]);
...
DB::table('questions_answers')->insert(['abcd' => 'D','content' => 'D. Thắng lợi, thi đua', 'correct' => false, 'question_id' => $id]);
...
DB::table('questions_answers')->insert(['abcd' => 'B','content' => 'B. Hòn đá vàng', 'correct' => false, 'question_id' => $id]);
...
']);
DB::table('questions_answers')->insert(['abcd' => 'A','content' => 'A. 26/1/1968', 'correct' => false, 'question_id' => $id]);
...
DB::table('questions_answers')->insert(['abcd' => 'D','content' => 'D. Cả 3 đáp án trên đều đúng.', 'correct' => false, 'question_id' => $id]);
...
DB::table('questions_answers')->insert(['abcd' => 'D','content' => 'D. Cả 3 loại chiến tranh trên', 'correct' => false, 'question_id' => $id]);
...
']);
DB::table('questions_answers')->insert(['abcd' => 'A','content' => 'A. Nhân đôi, phình to', 'correct' => false, 'question_id' => $id]);
...
DB::table('questions_answers')->insert(['abcd' => 'B','content' => 'B. Huỳnh Tấn Phát', 'correct' => false, 'question_id' => $id]);
...
DB::table('questions_answers')->insert(['abcd' => 'B','content' => 'B. Pari', 'correct' => false, 'question_id' => $id]);
...
DB::table('questions_answers')->insert(['abcd' => 'C','content' => 'C. Vừa đánh vừa đàm', 'correct' => false, 'question_id' => $id]);
...
DB::table('questions_answers')->insert(['abcd' => 'B','content' => 'B. Võ Nguyên Giáp', 'correct' => false, 'question_id' => $id]);
...
DB::table('questions_answers')->insert(['abcd' => 'C','content' => 'C. Lâm Đồng', 'correct' => false, 'question_id' => $id]);
...
DB::table('questions_answers')->insert(['abcd' => 'C','content' => 'C. 70 tỷ đô la', 'correct' => false, 'question_id' => $id]);
...
DB::table('questions_answers')->insert(['abcd' => 'B','content' => 'B. Trường Đại học Columbia', 'correct' => false, 'question_id' => $id]);
...
DB::table('questions_answers')->insert(['abcd' => 'C','content' => 'C. 130 trường', 'correct' => false, 'question_id' => $id]);
...
DB::table('questions_answers')->insert(['abcd' => 'B','content' => 'B. Từ chức', 'correct' => false, 'question_id' => $id]);
